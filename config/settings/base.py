...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="BEKA Ltd <no-reply@beka.co.ke>")
CONTACT_NOTIFY_EMAIL = env("CONTACT_NOTIFY_EMAIL", default="")

# --- BEKA Ltd company info, used by templates via a context processor ---
COMPANY_NAME = "BEKA Ltd"
